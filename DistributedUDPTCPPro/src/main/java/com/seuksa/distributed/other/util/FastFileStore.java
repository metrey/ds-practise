...
public class FastFileStore {
	...
	public FastFileStore(String fileName) throws IOException {
	...
	public List<Object> getObjects() throws IOException, ClassNotFoundException {
	 ...
	 * List
	 */
	public List<Object> getObjects(int fromIndex, int toIndex) throws IOException,
			ClassNotFoundException {
		List<Object> list = new LinkedList<Object>();
